...
const styles = StyleSheet.create({
  ...
  hoyBtnTexto: { color: colors.text, fontSize: 15, fontWeight: '700' },
  ...
  resumenPeriodo: { color: colors.textMuted, fontSize: 14, fontWeight: '600', textTransform: 'capitalize' },
  ...
  resumenValor: { color: colors.text, fontSize: 23, fontWeight: '800', marginTop: 2 },
  card: { backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: radius.md, padding: 16 },
  chartTitulo: { color: colors.text, fontSize: 15, fontWeight: '700', marginBottom: 12 },
  vacio: { color: colors.textMuted, fontSize: 15, fontStyle: 'italic', textAlign: 'center', marginTop: 8 },
});
