...
const styles = StyleSheet.create({
  ...
  navBtnTexto: { color: colors.text, fontSize: 18, fontWeight: '700' },
  navTitulo: { color: colors.text, fontSize: 15, fontWeight: '800', textTransform: 'capitalize' },
  semanaRow: { flexDirection: 'row' },
  semanaTexto: { flex: 1, textAlign: 'center', color: colors.textMuted, fontSize: 13, fontWeight: '700', paddingVertical: 4 },
  ...
  celdaTexto: { color: colors.text, fontSize: 14, fontWeight: '600' },
  ...
  hoyBtnTexto: { color: colors.accent, fontSize: 14, fontWeight: '700' },
});
