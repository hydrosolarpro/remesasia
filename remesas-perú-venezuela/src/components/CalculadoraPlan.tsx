...
import { PLANES, MAX_SLIDER, recomendarPlan } from '../data/planes';
...
export const CalculadoraPlan: React.FC<CalculadoraPlanProps> = ({ onOpenDemoModal }) => {
  ...
  const plan = recomendarPlan(clientes);
      ...
      <div className="max-w-6xl mx-auto space-y-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-black italic uppercase text-white tracking-wide">
            ¿Cuál Plan te <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Conviene</span>?
          </h2>
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
            Dinos cuántos clientes manejas y te mostramos automáticamente el plan que necesitas.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          >
            ...
            {plan ? (
              <>
                <div>
                  <h3 className="text-3xl font-black font-mono text-white uppercase tracking-wider">{plan.nombre}</h3>
                  ...
                  <p className="text-xs text-slate-400 mt-2">
                    Capacidad: Soporta hasta <span className="text-white font-bold">{plan.clientes} clientes</span>
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-slate-300">
                  <span className="flex items-center gap-1.5">
                    ...
                    {plan.operadoresPeru} Operadores Perú
                  </span>
                  <span className="flex items-center gap-1.5">
                    <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                    {plan.operadoresVenezuela} Operadores Venezuela
                  </span>
                </div>
                ...
                >
                  ...
                  <span>Solicitar Plan {plan.nombre}</span>
